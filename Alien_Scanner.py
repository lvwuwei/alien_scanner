...
def dtect():
	print("|----------------------------------------------------------------------------------------------------|")
	print("|  _   _   _  _      ____   _  __  _____   ____      ___   _____     _____   ___    _   _   _____    |")
	print("| | | | | | || |    / ___| | |/ / |___ /  |  _ \    |_ _| |_   _|   |__  /  / _ \  | \ | | | ____|   |")
	print("| | |_| | | || |_  | |     | ' /    |_ \  | |_) |    | |    | |       / /  | | | | |  \| | |  _|     |")
	print("| |  _  | |__   _| | |___  | . \   ___) | |  _ <     | |    | |      / /_  | |_| | | |\  | | |___    |")
	print("| |_| |_|    |_|    \____| |_|\_\ |____/  |_| \_\   |___|   |_|     /____|  \___/  |_| \_| |_____|   |")
	print("|                                                                                                    |")
	print("|-----------------------------------------Bangladesh Syber pro------------------------------{MR.X}---|")
	print("|                                                                                                    |")
	...
	def menu():
		...
		print("-->"+boldwhite+"Menu List"+reset+"<-- \n \n--->  1."+boldwhite+"WordPress Username Enumerator"+reset+"\n--->  2."+boldwhite+"Sensitive File Detector"+reset+"\n--->  3."+boldwhite+"Sub-Domain Scanning"+reset+"\n--->  4."+boldwhite+"Port Scanning"+reset+"\n--->  5."+boldwhite+"Wordpress Scanning\n"+reset+"--->  6."+boldwhite+"Cross-Site Scripting XSS Scanning\n"+reset+"--->  7."+boldwhite+"Wordpress Backup Grabber\n"+reset+"--->  8."+boldwhite+"SQL Injection SQLI Scanning\n"+reset)
